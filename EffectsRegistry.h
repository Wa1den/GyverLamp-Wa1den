...
static const char effectNamesList[] PROGMEM =
  "Белый свет;Цвет;Смена цвета;Безумие;Облака;Лава;Плазма;Радуга 3D;Павлин;"
  "Зебра;Лес;Океан;Мячики;Мячики без границ;Попкорн;Спирали;Призмата;"
  "Дымовые шашки;Пламя;Огонь 2021;Тихий океан;Тени;ДНК;Стая;Стая и хищник;"
  "Мотыльки;Лампа с мотыльками;Змейки;Nexus;Шары;Синусоид;Метаболз;"
  "Северное сияние;Плазменная лампа;Лавовая лампа;Жидкая лампа;"
  "Жидкая лампа (auto);Капли на стекле;Матрица;Огонь 2012;Огонь 2018;"
  "Огонь 2020;Огонь;Вихри пламени;Разноцветные вихри;Магма;Кипение;Водопад;"
  "Водопад 4 в 1;Бассейн;Пульс;Радужный пульс;Белый пульс;Осциллятор;"
  "Источник;Фея;Комета;Одноцветная комета;Две кометы;Три кометы;Притяжение;"
  "Парящий огонь;Верховой огонь;Радужный змей;Конфетти;Мерцание;Дым;"
  "Разноцветный дым;Пикассо;Волны;Цветные драже;Кодовый замок;Кубик Рубика;"
  "Тучка в банке;Гроза в банке;Осадки;Разноцветный дождь;Снегопад;"
  "Звездопад / Метель;Прыгуны;Светлячки;Светлячки со шлейфом;Люменьер;"
  "Пейнтбол;Радуга;Часы;Бегущая строка";
