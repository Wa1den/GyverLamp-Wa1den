// Управление WiFi подключением на библиотеке WiFiConnector (замена WiFiManager + CaptivePortalManager).
//
// Поведение:
...
//    в режиме точки доступа (без перезагрузки, в отличие от старой прошивки) - можно в любой
//    момент зайти на http://192.168.4.1 и настроить сеть.
...
// сброс сохранённых SSID и пароля WiFi сети (замена wifiManager.resetSettings())
