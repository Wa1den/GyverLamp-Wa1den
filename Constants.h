...
// --- ЭФФЕКТЫ -------------------------
#define RUNNING_TEXT_DEFAULT  ("сосал?")                    // текст, который будет выводиться в эффекте Бегущая строка по умолчанию. его можно менять в приложении
...
#define MQTT_DEFAULT_HOST     ("m6.wqtt.ru")                // адрес MQTT брокера
#define MQTT_DEFAULT_PORT     (13574U)                      // порт MQTT брокера
#define MQTT_DEFAULT_USER     ("u_G96NQD")                  // пользователь MQTT брокера
#define MQTT_DEFAULT_PASS     ("SuJfdnMk")                  // пароль пользователя MQTT брокера
#endif
...
#define MAX_UDP_BUFFER_SIZE   (255U)                        // максимальный размер буфера команд/текста (используется MQTT, бегущей строкой и FavoritesManager; название историческое)
