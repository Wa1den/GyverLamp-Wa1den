...
#include "Config.h"
#include "Version.h"                                          // имя, версия и авторство прошивки (строка Firmware в веб-интерфейсе)
...
// AP_NAME/AP_PASS (начальные имя и пароль, дальше они задаются на странице настроек) — в Config.h
